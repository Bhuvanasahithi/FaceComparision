...
public  class PersonRecognizer {
	...
	PersonRecognizer(String path) {
		//parameters-radius,-The radius used for building the Circular Local Binary Pattern
		// neighbours,-The number of sample points to build a Circular Local Binary Pattern from. An appropriate value is to use `` 8``
